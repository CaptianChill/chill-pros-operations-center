...
document.write('<link rel="stylesheet" href="brand-lock.css?v=20260722-16">');
document.write('<link rel="stylesheet" href="final-template.css?v=20260722-16">');
document.write('<link rel="stylesheet" href="production-owner.css?v=20260722-16">');
document.write('<link rel="manifest" href="manifest.webmanifest?v=20260722-16">');
document.write('<link rel="icon" type="image/png" sizes="1024x1024" href="cp-app-icon.png?v=20260722-16">');
document.write('<link rel="apple-touch-icon" sizes="1024x1024" href="cp-app-icon.png?v=20260722-16">');
...
document.write('<script src="auth-diagnostics.js?v=20260722-16"><\/script>');
// Approved dashboard composition and production-only live data cleanup.
document.write('<script src="final-template.js?v=20260722-16"><\/script>');
document.write('<script src="production-owner.js?v=20260722-16"><\/script>');
